...
import type IBancoController from './IBancoController.js';
...
export default class BancoController implements IBancoController {
    ...
    constructor(
        ...
        @Inject('DespesaRecorrenteProcessadorService') private despesaRecorrenteService: IDespesaRecorrenteProcessadorService
    ) {}
